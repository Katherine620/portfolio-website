...
const EmailSection = () => {
    return (
        <section className="grid md:grid-rows-2 my-12 md:my-12 py-24 gap-4 relative justify-items-center" id="contact">
            ...
            <div className="z-10 justify-items-center">
                <h1 className="text-2xl md:text-4xl font-bold text-white my-2">Let&apos;s Connect</h1>
            ...
            <div className="grid place-items-center">
                <a
                    ...
                    className="bg-tertiary-500 hover:bg-tertiary-600 text-white font-medium py-2.5 px-5 rounded-lg w-full transitaion-all duration-300 ease-in-out hover:-translate-x-2 hover:-translate-y-2 hover:shadow-lg hover:shadow-tertiary-500/80"
                >
                    Say Hello
                </a>
            </div>
